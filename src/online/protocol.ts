...
export const LOGO_PACK: TeamLogoOption[] = [
  ...
  { id: '🐆', label: 'Leopard',   category: 'Beasts' },
  { id: '🦖', label: 'T-Rex',     category: 'Beasts' },
  { id: '🦏', label: 'Rhino',     category: 'Beasts' },
  { id: '🐅', label: 'Panther',   category: 'Beasts' },
  { id: '🦉', label: 'Owl',       category: 'Beasts' },
  { id: '🐗', label: 'Boar',      category: 'Beasts' },
  { id: '🐊', label: 'Croc',      category: 'Beasts' },
  { id: '🦩', label: 'Flamingo',  category: 'Beasts' },
  { id: '🦌', label: 'Stag',      category: 'Beasts' },
  { id: '🐙', label: 'Kraken',    category: 'Beasts' },
  { id: '🦑', label: 'Squid',     category: 'Beasts' },
  { id: '🐳', label: 'Whale',     category: 'Beasts' },
  { id: '🐴', label: 'Stallion',  category: 'Beasts' },
  { id: '🦬', label: 'Bison',     category: 'Beasts' },
  ...
  { id: '❄',  label: 'Snowflake', category: 'Elements' },
  { id: '🌪', label: 'Tornado',   category: 'Elements' },
  { id: '🌋', label: 'Volcano',   category: 'Elements' },
  { id: '☀',  label: 'Sun',       category: 'Elements' },
  { id: '🌙', label: 'Moon',      category: 'Elements' },
  { id: '💫', label: 'Sparkle',   category: 'Elements' },
  { id: '🌈', label: 'Rainbow',   category: 'Elements' },
  { id: '⭐', label: 'Nova',      category: 'Elements' },
  { id: '🌀', label: 'Cyclone',   category: 'Elements' },
  ...
  { id: '🏹', label: 'Bow',       category: 'Combat' },
  { id: '🗡',  label: 'Dagger',   category: 'Combat' },
  { id: '⛓',  label: 'Chains',    category: 'Combat' },
  { id: '💣', label: 'Bomb',      category: 'Combat' },
  { id: '🪓', label: 'Axe',       category: 'Combat' },
  { id: '🎳', label: 'Strike',    category: 'Combat' },
  { id: '🥊', label: 'Boxer',     category: 'Combat' },
  ...
  { id: '🎭', label: 'Mask',      category: 'Symbols' },
  { id: '💀', label: 'Skull',     category: 'Symbols' },
  { id: '☠',  label: 'Crossbones',category: 'Symbols' },
  { id: '🎃', label: 'Pumpkin',   category: 'Symbols' },
  { id: '👻', label: 'Ghost',     category: 'Symbols' },
  { id: '♠',  label: 'Spade',     category: 'Symbols' },
  { id: '♣',  label: 'Club',      category: 'Symbols' },
  { id: '♥',  label: 'Heart',     category: 'Symbols' },
  { id: '♦',  label: 'Diamond2',  category: 'Symbols' },
  { id: '🎲', label: 'Dice',      category: 'Symbols' },
  { id: '🃏', label: 'Joker',     category: 'Symbols' },
  { id: '🎰', label: 'Slots',     category: 'Symbols' },
  { id: '🎪', label: 'Circus',    category: 'Symbols' },
  { id: '🔮', label: 'Oracle',    category: 'Symbols' },
  { id: '⚓', label: 'Anchor',    category: 'Symbols' },
  { id: '🚀', label: 'Rocket',    category: 'Symbols' },
  { id: '🛸', label: 'UFO',       category: 'Symbols' },
  { id: '🏴', label: 'Flag',      category: 'Symbols' },
  { id: '☯',  label: 'Yin-Yang',  category: 'Symbols' },
  { id: '🕉',  label: 'Om',        category: 'Symbols' },
  { id: '⚛',  label: 'Atom',      category: 'Symbols' },
  { id: '🕶', label: 'Shades',    category: 'Symbols' },
  { id: '🎧', label: 'Beats',     category: 'Symbols' },
];
...
export type ServerMessage =
  ...
  | { kind: 'hello-bad-pin' }
  | { kind: 'state'; team: OnlineTeam; players: Player[]; dailyBonusAvailable: boolean; freeCaseAvailable: boolean; duelsUsed: number; duelsRefillsUsed: number; moraleGamePlaysUsed: number; nextTickUtcMs: number; matchCooldownUntilMs?: number }
